...
class ProductController extends Controller
{
    ...
    //         'variation_values.*.date_on_sale_from' => 'required_with:variation_values.*.sale_price',
    //         'variation_values.*.date_on_sale_to' => 'required_with:variation_values.*.sale_price',
    //     ]);

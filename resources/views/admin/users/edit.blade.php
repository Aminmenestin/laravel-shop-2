            ...
            <form action="{{ route('admin.users.update', ['user' => $user->id]) }}" method="POST">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control" name="cellphone" type="text" value="{{ $user->cell_phone }}">
                    </div>
                    <div class="form-group col-md-3">
                    ...
                    <div class="accordion col-md-12 mt-3" id="accordionPermission">
                        <div class="card">
                            <div class="card-header p-1 d-flex align-items-center" id="headingOne">
                                ...
                                <input style="margin-right: 155px" type="checkbox" id="select-all"
                                ...
                                <div class="card-body row">
                                    @foreach ($permissions as $permission)
                                        <div class="form-group form-check col-md-3">
                                            ...
                                            <label style="padding-right: 10px;padding-top: 3px"

...
<script>
    ...
    let banner_position = @json($banner).banner_position;

    $(`#banner_position option[value=${banner_position}]`).attr('selected','selected')
        ...
        <div class="col-xl-12 col-md-12 mb-4 p-4 bg-white">
            ...
            <form action="{{ route('admin.banner.update' , ['banner' => $banner]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row justify-content-center mb-3">
                    <div class="col-md-4">
                        <div class="card">
                            <img class="card-img-top" src="{{ url( env('BANNER_UPLOAD_PATH').$banner->image ) }}" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control" id="text" name="description" type="text" value="{{ $banner->description }}">
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control" id="button_text" name="button" type="text" value="{{ $banner->button }}">
                    </div>
                </div>

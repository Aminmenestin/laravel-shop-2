                    ...
                    <tbody>
                        @foreach ($brands as $key => $brand)
                            <tr>
                                ...
                                <th>
                                    <span class="{{$brand->getRawOriginal('is_active') == 1 ? 'text-success' : 'text-danger'}}">{{$brand->is_active }}</span>
                                </th>
                                <th>
                                    ...
                                    <a class="btn btn-sm btn-outline-danger mr-3" href="{{route('admin.brands.destroy' , ['brand' => $brand->id])}}" data-confirm-delete="true">حذف</a>

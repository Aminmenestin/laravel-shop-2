 ...
 <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion pr-0" id="accordionSidebar">
     ...
     <!-- Nav Item - Pages Collapse Menu -->
     <li class="nav-item">
         <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsebrans"
     ...
     <li class="nav-item">
         <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsecategoies"
             aria-expanded="true" aria-controls="collapsePages">
             <i class="fa-solid fa-folder fa-lg"></i>
             <i class="fa-solid fa-folder-open fa-lg"></i>
             <span>دسته بندی ها</span>
         </a>
         <div id="collapsecategoies" class="collapse" aria-labelledby="headingPages"
             data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
     ...
     <li class="nav-item">
         ...
         <div id="collapseusers" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 <h6 class="collapse-header">کاربر ها</h6>
                 <a class="collapse-item" href="{{ route('admin.users.index') }}"> نمایش کاربر ها </a>
                 <a class="collapse-item" href="{{ route('admin.roles.index') }}"> گروه های کاربری</a>
                 <a class="collapse-item" href="{{ route('admin.permissions.index') }}"> پرمیشن ها</a>
             </div>
         </div>
     </li>
     @endcan

                    ...
                    <ul>
                      <li class="single-shopping-cart">
                        ...
                        <div class="shopping-cart-img">
                          <a href="#"><img alt="" src="{{asset('home/img/cart/cart-1.svg')}}" /></a>
                      ...
                      <li class="single-shopping-cart">
                        ...
                        <div class="shopping-cart-img">
                          <a href="#"><img alt="" src="{{asset('home/img/cart/cart-2.svg')}}" /></a>
                          <div class="item-close">
                            <a href="#"><i class="sli sli-close"></i></a>
                          </div>
                        </div>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-6">
                <div class="slider-single-img slider-animated-1">
                  ...
                  <img class="animated" src="{{asset('home/img/slider/1.jfif')}}" alt="" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-6">
                <div class="slider-single-img slider-animated-1">
                  ...
                  <img class="animated" src="{{asset('home/img/slider/2.jfif')}}" alt="" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-4">
            <div class="single-banner mb-30 scroll-zoom">
              <a href="product-details.html"><img class="animated" src="{{asset('home/img/banner/banner-6.png')}}" alt="" /></a>
          ...
          <div class="col-lg-4 col-md-4">
            <div class="single-banner mb-30 scroll-zoom">
              <a href="product-details.html"><img class="animated" src="{{asset('home/img/banner/banner-7.png')}}" alt="" /></a>
              <div class="banner-content-2 banner-position-5">
                <h4>جین</h4>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-4">
            <div class="single-banner mb-30 scroll-zoom">
              <a href="product-details.html"><img class="animated" src="{{asset('home/img/banner/banner-8.png')}}" alt="" /></a>
              <div class="banner-content-2 banner-position-5">
                <h4>مردانه</h4>
              </div>
            </div>
          ...
          <div class="col-lg-6 col-md-6">
            <div class="single-banner mb-30 scroll-zoom">
              <a href="product-details.html"><img class="animated" src="{{asset('home/img/banner/banner-9.png')}}" alt="" /></a>
          ...
          <div class="col-lg-6 col-md-6">
            <div class="single-banner mb-30 text-center scroll-zoom">
              <a href="product-details.html"><img class="animated" src="{{asset('home/img/banner/banner-10.png')}}" alt="" /></a>
            ...
            <div class="ht-products product-slider-active owl-carousel">
                ...
                <div class="ht-product-inner">
                  <div class="ht-product-image-wrap">
                    <a href="product-details.html" class="ht-product-image">
                      <img src="{{asset('home/img/product/product-1.svg')}}" alt="Universal Product Style" />
                    </a>
              ...
              <div class="ht-product ht-product-action-on-hover ht-product-category-right-bottom mb-30">
                <div class="ht-product-inner">
                  <div class="ht-product-image-wrap">
                    <a href="product-details.html" class="ht-product-image">
                      <img src="{{asset('home/img/product/product-2.svg')}}" alt="Universal Product Style" />
                    </a>
                    <div class="ht-product-action">
                      <ul>
                        <li>
              ...
              <div class="ht-product ht-product-action-on-hover ht-product-category-right-bottom mb-30">
                <div class="ht-product-inner">
                  <div class="ht-product-image-wrap">
                    <a href="product-details.html" class="ht-product-image">
                      <img src="{{asset('home/img/product/product-3.svg')}}" alt="Universal Product Style" />
                    </a>
                    <div class="ht-product-action">
                      <ul>
                        <li>
              ...
              <div class="ht-product ht-product-action-on-hover ht-product-category-right-bottom mb-30">
                <div class="ht-product-inner">
                  <div class="ht-product-image-wrap">
                    <a href="product-details.html" class="ht-product-image">
                      <img src="{{asset('home/img/product/product-4.svg')}}" alt="Universal Product Style" />
                    </a>
                    <div class="ht-product-action">
                      <ul>
                        <li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-md-6 text-right">
            <div class="single-banner mb-30 scroll-zoom">
              <a href="product-details.html"><img src="home/img/banner/banner-4.png" alt="" /></a>
          ...
          <div class="col-lg-6 col-md-6 text-right">
            <div class="single-banner mb-30 scroll-zoom">
              <a href="product-details.html"><img src="home/img/banner/banner-5.png" alt="" /></a>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-4 col-md-3 col-12">
              <div class="payment-mathod pb-20">
                <a href="#"><img src="home/img/icon-img/payment.png" alt="" /></a>
              </div>
            </div>
          </div>
        </div>
